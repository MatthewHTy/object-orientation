...
class Wizard {
  ...
  const wizard = new Wizard ('Merlin', '5000', 'FireBall')
wizard.castSpell()
//////////////////////////// PROBLEM 10 ////////////////////////////
/*
...
let phoneTwo = new Phone('Samsung', 'Galaxy S9', 256, 'rose', 900)
let phoneThree = new Phone('Pixel', 'Pixel 1', 256, 'black', 900)
...
const myFirstVehicle = new Vehicle ('500', 'Black', '13300')
...
const myFirstMotorcycle = new Motorcycle(1, 'red', 1500, 'Kawasaki', true)
...
const myFirstBoat = new Boat(20, 'black', 5000, 'Yakatawa', 'yacht', false)
